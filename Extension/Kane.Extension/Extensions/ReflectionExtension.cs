...
namespace Kane.Extension
{
    ...
    public static class ReflectionExtension
    {
        ...
        /// <para>也可使用<see cref="ExpressionExtension.GetPropValueExp{TSource, TResult}(TSource, string)"/>表达式树方法实现，性能高一些</para>
        /// </summary>
        /// <typeparam name="TSource">反射对象类型</typeparam>
        ...
        /// <summary>
        /// 通过反射，根据属性名称设置属性的值
        /// <para>也可以使用<see cref="ExpressionExtension.SetPropValueExp{TSource, TValue}(TSource, string, TValue)"/>表达式树方法实现，性能高一些</para>
        /// </summary>
        /// <typeparam name="TSource">反射对象类型</typeparam>
