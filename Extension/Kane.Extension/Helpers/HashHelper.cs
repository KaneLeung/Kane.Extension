...
namespace Kane.Extension
{
    ...
    public class HashHelper
    {
        ...
        /// <param name="encoding">设置编码</param>
        /// <returns>全小写</returns>
        public string Md5(string data, string salt, Encoding encoding) => Md5(string.Concat(data, salt), encoding);
        #endregion
        ...
        /// <param name="encoding">设置编码</param>
        /// <returns>全小写</returns>
        public string Sha1(string data, string salt, Encoding encoding) => Sha1(string.Concat(data, salt), encoding);
        #endregion
        ...
        /// <param name="encoding">设置编码</param>
        /// <returns>全小写</returns>
        public string Sha256(string data, string salt, Encoding encoding) => Sha256(string.Concat(data, salt), encoding);
        #endregion
        ...
        /// <param name="encoding">设置编码</param>
        /// <returns>全小写</returns>
        public string Sha384(string data, string salt, Encoding encoding) => Sha384(string.Concat(data, salt), encoding);
        #endregion
        ...
        /// <param name="encoding">设置编码</param>
        /// <returns>全小写</returns>
        public string Sha512(string data, string salt, Encoding encoding) => Sha512(string.Concat(data, salt), encoding);
        #endregion
