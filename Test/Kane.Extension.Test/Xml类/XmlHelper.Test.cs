...
namespace Kane.Extension.Test
{
    ...
    {
        [TestMethod]
        public void StreamToObjectTest()
        {
            using var stream = new MemoryStream(GlobalData.RsaPrivateXmlKey.ToBytes());
            var rsa = stream.ToObject<RsaModels>();
        ...
        public void TestObjectToXml()
        {
            ...
            Assert.AreEqual(GlobalData.RsaPrivateXmlKey, rsa.ToXml(new Dictionary<string, string> { { string.Empty, string.Empty } }, settings));
        }
    }
}